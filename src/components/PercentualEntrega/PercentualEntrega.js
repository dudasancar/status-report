                ...
                <Total>
                    <CardMaior>
                        ...
                        <CardMenor>
                            ...
                            <Dados>{epic.name} (77%)</Dados>
                            {aparecer&& (<Horas>M28h / m32h <img src={PoligonoVermelho} alt="poligono vermelho" /> / R56h <img src={PoligonoVermelho} alt="poligono vermelho"/></Horas>)}
                                
                            <Progress percent={100} showInfo={false} trailColor="#F6F7F6" strokeColor="#0A56A2" strokeWidth={25} />
                            <Dados>Login (100%)</Dados>
                            {aparecer&& (<Horas1>M28h / m12h <img src={PoligonoVerde} alt="poligono verde"/> / R26h <img src={PoligonoVerde} alt="poligono verde"/></Horas1>)}
                            ...
                            {aparecer&& (<Horas2>M28h / m12h <img src={PoligonoVerde} alt="poligono verde"/> / R56h <img src={PoligonoVermelho} alt="poligono verde"/></Horas2>)} 
        
                            <Progress percent={10} showInfo={false} trailColor="#F6F7F6" strokeColor="#0A56A2" strokeWidth={25} />
                            <Dados>Lorem ipsum dolor (10%)</Dados>
                            {aparecer&& (<Horas3>M28h / m12h <img src={PoligonoVerde} alt="poligono verde"/> / R56h <img src={PoligonoVermelho} alt="poligono vermelho"/></Horas3>)} 
        
                            <Progress percent={5} showInfo={false} trailColor="#F6F7F6" strokeColor="#0A56A2" strokeWidth={25} />
                            <Dados>Dolor ipsum (5%)</Dados>
                            {aparecer&& (<Horas4>M28h / m12h <img src={PoligonoVerde} alt="poligono verde"/> / R56h <img src={PoligonoVermelho} alt="poligono vermelho"/></Horas4>)}
        
                            <Progress percent={20} showInfo={false} trailColor="#F6F7F6" strokeColor="#0A56A2" strokeWidth={25} />
                            <Dados>Ipsum dolor (20%)</Dados>
                            {aparecer&& (<Horas5>M28h / m12h <img src={PoligonoVerde} alt="poligono verde"/> / R5h</Horas5>)} 
